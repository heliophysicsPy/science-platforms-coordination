...
A Docker image containing all PyHC packages, to be used by the Science Platforms Coordination IHDEA working group. Source files and pipeline live in [this separate repo](https://github.com/heliophysicsPy/pyhc-docker-environment/tree/main/docker/pyhc-environment).
